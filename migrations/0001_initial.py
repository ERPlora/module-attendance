    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('break_minutes', models.PositiveIntegerField(default=0, verbose_name='Break Minutes')),
                ('total_hours', models.DecimalField(decimal_places=2, default='0', max_digits=5, verbose_name='Total Hours')),
                ('status', models.CharField(choices=[('present', 'Present'), ('late', 'Late'), ('absent', 'Absent'), ('half_day', 'Half Day'), ('remote', 'Remote')], default='present', max_length=20, verbose_name='Status')),
